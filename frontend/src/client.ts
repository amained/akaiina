// Code generated by the Encore v1.39.0 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-akaiina-2fpi.encr.app`
}
...
export namespace yume {
    ...
    export interface NewDocumentParams {
        ...
        NAME: string
        /**
         * please base64 encode the content
         */
        "CONTENT_BASE64": string
    }

    export interface NewUserNamespaceParams {
        NAME: string
        OWNER: string
    }

    export interface QueryUserNamespaceParams {
        /**
         * id of the document
         */
        DOCUMENTID: string
    ...
    export class ServiceClient {
        ...
        public async InsertToUserNamespace(id: string, params: QueryUserNamespaceParams): Promise<void> {
            await this.baseClient.callAPI("POST", `/yume/userns/insert/${encodeURIComponent(id)}`, JSON.stringify(params))
        }

        public async NewDocument(params: NewDocumentParams): Promise<Document> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/yume/documents/new`, JSON.stringify(params))
            return await resp.json() as Document
        }

        public async NewUserNamespace(params: NewUserNamespaceParams): Promise<UserNamespace> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/yume/userns/new`, JSON.stringify(params))
            return await resp.json() as UserNamespace
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "akaiina-2fpi-Generated-TS-Client (Encore/v1.39.0)";
        }
